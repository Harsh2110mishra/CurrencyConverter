...
public class AboutWindow extends JFrame {
	...
	private AboutWindow() {
		...
		JLabel lblLink = new JLabel("https://github.com/Harsh2110mishra/CurrencyConverter");
		...
		lblLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://github.com/Harsh2110mishra/CurrencyConverter"));
                } catch (Exception ex) {
                	ex.printStackTrace();
                }
            }
